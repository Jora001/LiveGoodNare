  ...
  <span className="font-medium text-gray-800">+37493097970</span>
          ...
          <div className="flex flex-col items-center lg:justify-end animate-float">
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-secondary to-accent rounded-full blur-2xl opacity-30 scale-110 animate-pulse-glow" style={{animationDelay: '1s'}}></div>
              <img
                src={ceoPhoto}
...
Здравствуйте, я Наре, партнёр компании LiveGood.              </p>
            </div>
          </div>
        </div>
      </div>
