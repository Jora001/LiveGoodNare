...
import ceoPhoto from "@/assets/ceo-photo.jpg"; // քո լուսանկարը
...
const ChatbotSlideIn = () => {
  ...
  return (
    <>
      ...
      {/* Slide-in panel */}
      <div
        className={`fixed top-1/4 right-0 h-auto w-64 bg-white shadow-2xl z-50 transform transition-transform duration-500 rounded-l-3xl overflow-hidden ${
      ...
      >
        ...
        <div className="p-4 flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-green-600 font-medium text-sm"> партнёр компании LiveGood</p>
