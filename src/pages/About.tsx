          ...
          <div className="container mx-auto relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="bg-gradient-glass backdrop-blur-sm p-10 rounded-3xl border border-border/20 shadow-elegant animate-fade-in">
                ...
                <h3 className="text-3xl font-bold text-foreground mb-6 text-primary">Ежедневное обучение</h3>
              ...
              <div className="bg-gradient-glass backdrop-blur-sm p-10 rounded-3xl border border-border/20 shadow-elegant animate-fade-in" style={{animationDelay: '200ms'}}>
                ...
                <h3 className="text-3xl font-bold text-foreground mb-6 text-secondary">Развитие команды и региональные тренинги</h3>
                <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              {[
                {
                  ...
                  description: "Станьте частью мощной команды с большим видением, постоянно развивающейся и совершенствующейся",
                  gradient: "from-primary to-primary-glow"
                },
                {
                  title: "Прозрачность и рост дохода",
                  description: "Вы получите активный или пассивный доход, который будет постоянно расти, открывая двери к вашим мечтам.",
                  gradient: "from-secondary to-accent"
                },
                {
                  title: "Выгода от больших скидок",
                  description: "Присоединившись к нам, вы сможете пользоваться нашим ассортиментом продуктов по беспрецедентно низким ценам.",
                ...
                >
                  <div className={`w-16 h-16 bg-gradient-to-r ${value.gradient} rounded-2xl flex items-center justify-center mb-6 shadow-glow group-hover:scale-110 transition-transform duration-300`}>
                    <div className="w-8 h-8 bg-primary-foreground rounded-lg"></div>
                  </div>
